...
export default function FormulaBlock({ formula, block, title }: FormulaBlockProps) {
  ...
  return (
    <div className={block ? "my-6 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border-2 border-blue-200 shadow-sm" : "inline"}>
      ...
      <div className={block ? "space-y-2 text-center text-base font-mono text-gray-800 bg-white p-4 rounded border border-blue-100 overflow-x-auto custom-scrollbar" : "inline font-mono text-sm text-gray-700"}>
        {block ? (
