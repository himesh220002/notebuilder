export const formulaText = {
    ...
    setBuilderForm: "Using a property $P(x)$ to define elements, e.g., $A = \\{x : x \\in \\mathbb{N}, x < 5\\}$.",
    ...
    // Relations
    cartesianProduct: "$A \\times B = \\{(a, b) : a \\in A, b \\in B\\}$. If $n(A)=p, n(B)=q$, then $n(A \\times B) = pq$.",
    relationDef: "A relation $R$ from a non-empty set $A$ to a non-empty set $B$ is a subset of the Cartesian product $A \\times B$.",
    ...
    realFunction: "A function whose range is a subset of $\\mathbb{R}$ is called a real-valued function. If domain is also subset of $\\mathbb{R}$, it's a real function.",

    // Algebra of Functions
    funcAddition: "$(f + g)(x) = f(x) + g(x)$",
    funcSubtraction: "$(f - g)(x) = f(x) - g(x)$",
    funcMultiplication: "$(f \\cdot g)(x) = f(x) \\cdot g(x)$",
    funcDivision: "$(\\frac{f}{g})(x) = \\frac{f(x)}{g(x)}, \\text{ provided } g(x) \\neq 0$",

    // Composite Functions
    compositeDef: "Let $f: A \\rightarrow B$ and $g: B \\rightarrow C$. The composition of $f$ and $g$, denoted by $g \\circ f$, is defined as $(g \\circ f)(x) = g(f(x))$ for all $x \\in A$.",
    compositeProperties: "1. Generally $g \\circ f \\neq f \\circ g$ (Not Commutative).\n2. $(h \\circ g) \\circ f = h \\circ (g \\circ f)$ (Associative).",
...
export const compositeExamples = [
    {
        ...
        note: "Note: $(f \\circ g)(x) = f(g(x)) = f(x^2) = 2x^2$. Here $g \\circ f \\neq f \\circ g$."
    },
    {
        id: "c2",
        f: "$f(x) = \\sin x$",
...
export const examProblems = [
    {
        ...
        solution: "$f(f(x)) = f(x^2 - 3x + 2)$ \n$= (x^2 - 3x + 2)^2 - 3(x^2 - 3x + 2) + 2$. \n(Expand if required, but usually step substitution marks are key).",
...
export const problems = [
    ...
    {
        id: "s1",
        question: "Write $A = \\{x : x \\text{ is an integer and } -3 < x < 7\\}$ in roster form.",
    ...
    {
        id: "r1",
        question: "If $A = \\{1, 2\\}, B = \\{3, 4\\}$, find $A \\times B$.",
        solution: "$A \\times B = \\{(1, 3), (1, 4), (2, 3), (2, 4)\\}$.",
        difficulty: "easy" as const
    },
    {
        id: "r2",
