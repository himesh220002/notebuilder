...
import { formulaText, problems, rules } from "./data";
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16 py-16">
              ...
              <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
                ...
                <div className="mt-4 text-sm text-gray-600">
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li><MathText text="$\log(1234) \rightarrow 4$ digits $\rightarrow$ Char $= 3$" /></li>
                    <li><MathText text="$\log(3.45) \rightarrow 1$ digit $\rightarrow$ Char $= 0$" /></li>
                    <li><MathText text="$\log(0.005) \rightarrow 2$ zeros after decimal $\rightarrow$ Char $= \bar{3}$" /></li>
                  </ul>
                </div>
              </div>
        ...
        <section className="mb-16">
          ...
          <ProblemList problems={problems} title="Chapter 2 Practice Problems" />
        </section>
