...
export default function PermutationsAndCombinations() {
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            <ChapterNavbar currentChapter={5} totalChapters={17} />
            {/* Header */}
            ...
            <main className="max-w-[1200px] mx-auto p-6 space-y-12">
                ...
                <section className="mb-20">
                    ...
                    <div className="mt-12">
                        ...
                        <ProblemList problems={examProblems} title="Important Questions (Applied Maths)" chapterId="chapter5_exam" showTestButton={true} />
                    </div>
                </section>
