export const taxationData = {
    gst: {
        ...
        rates: ["0%", "5%", "12%", "18%", "28%"],
        itcFormula: "$text{GST Payable} = text{Output GST} - text{Input Tax Credit (ITC)}$"
    },
    incomeTax: {
        terms: [
...
export const problems = [
    {
        ...
        solution: "1. CP for Retailer = $5000 - 20\\% of 5000 = ₹4000$\n2. SP for Retailer = Mark Price = ₹5000\n3. Input Tax for Retailer = $18\\% of 4000 = ₹720$\n4. Output Tax for Retailer = $18\\% of 5000 = ₹900$\n5. GST Payable by Retailer = Output Tax - Input Tax = $900 - 720 = ₹180$",
    ...
    },
    {
        ...
        solution: "1. SP = $4000 + 25\\% of 4000 = ₹5000$\n2. GST = $5\\% of 5000 = ₹250$\n3. Consumer Pays = $5000 + 250 = ₹5,250$",
        difficulty: "easy" as const
    }
];
